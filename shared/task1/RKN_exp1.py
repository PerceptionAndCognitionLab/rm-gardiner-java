...
def recognition(test_list, ID=999):
    ...
    data_file = open(SAVELOC + "P" + str(ID) + '_RKN_' + expInfo['dateStr'] + '.csv', 'w')
...
def main():
    ...
    win.flip(); core.wait(1)
    acc=recognition(test_list = test_list, ID=expInfo['ID'])
